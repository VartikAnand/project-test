            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                  ...
                  you. Whether you have a question, need assistance, or want to
                  explore potential opportunities with us, we're here to help.
                  Please feel free to reach out through our contact form or by
                  phone, email, or visiting our location. Our knowledgeable team
                  is dedicated to providing prompt and thoughtful responses to
                  ensure your needs are fully addressed.
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      House no. 115, Sanjeevni Nagar, Garha, Jabapur,Madhya
                      Pradesh
                    </p>
                  </div>
                </div>
